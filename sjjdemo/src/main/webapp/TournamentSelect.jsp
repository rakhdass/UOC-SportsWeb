...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="csslanding/bootstrap.min.css" rel="stylesheet">
    <!-- Material Design Bootstrap -->
    <link href="csslanding/mdb.min.css" rel="stylesheet">
    <!-- Your custom styles (optional) -->
    <link href="csslanding/style.min.css" rel="stylesheet">
...
<%
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link waves-effect" href="" target="_blank"> Events</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link waves-effect" href="" target="_blank">Forum</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link waves-effect" href="" target="_blank">Sponsor</a>
                        </li>
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenu4">
        <a class="dropdown-item" href="Welcome.jsp">Freshers</a>
        <a class="dropdown-item" href="#">Inter Faculty</a>
        <a class="dropdown-item" href="#">Inter University</a>
...
<div class="text-center">
    ...
    <!-- SCRIPTS -->
    <!-- JQuery -->
    <script type="text/javascript" src="jslanding/jquery-3.3.1.min.js"></script>
    <!-- Bootstrap tooltips -->
    <script type="text/javascript" src="jslanding/popper.min.js"></script>
    <!-- Bootstrap core JavaScript -->
    <script type="text/javascript" src="jslanding/bootstrap.min.js"></script>
    <!-- MDB core JavaScript -->
    <script type="text/javascript" src="jslanding/mdb.min.js"></script>
    <!-- Initializations -->
